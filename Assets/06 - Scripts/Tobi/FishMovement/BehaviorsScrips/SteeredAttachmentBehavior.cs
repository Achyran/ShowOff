...
[CreateAssetMenu(menuName = "Flock/Behavior/SteeredAttachment")]
public class SteeredAttachmentBehavior : FilterdFlockBehavior
{
    [SerializeField]
    private float agentSoomthTime = 0.5f;
    ...
    public override Vector3 CalculateMove(FlockAgent agent, List<Transform> ctx, Flock flock)
    {
        ...
        calcmove = Vector3.SmoothDamp(agent.transform.forward, calcmove, ref currentVelocity, agentSoomthTime);
